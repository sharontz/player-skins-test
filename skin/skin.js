...
vdb.skins.BigPlayPause = vdb.EventBus.extend(function() {
    ...
    var shareScreenOpened = function() {
        this.shareScreen = true;
        utl.setStyle(this.bigButtonWrapper, {display:"none"});
    };
    var shareScreenClosed = function() {
        this.shareScreen = false;
        utl.setStyle(this.bigButtonWrapper, {display:"block"});
    };
    var bigButtonClick = function() {
        this.controller.togglePlay();
    };
    var adMeta = function() {
        this.ads = true;
    };
    var adStart = function() {
        this.ads = true;
    ...
    var switchToPauseIcon = function() {
        utl.removeClass(this.bigButton, "playState");
        utl.removeClass(this.bigButton, "pauseState");
        utl.removeClass(this.bigButton, "animate");
        utl.removeClass(this.bigButton, "animate180");
    ...
    var stopAnimation = function(state) {
        utl.addClass(this.bigButton, state);
    };
    var showBigButton = function() {
    ...
    return{init:function(controller, parent, container) {
...
vdb.skins.CcMenu = vdb.core.Class.extend(function() {
    ...
    var buildSupportedLanguagesColumn = function(supportedLanguagesMenu, supportedLanguagesSubList) {
    ...
    var buildGenericList = function(parent, attributes, items, callback, markSelection, selectedIndex) {
    ...
    var updateGenericList = function(ul, items, callback, markSelection, selectedIndex) {
        var attrs;
        var i = -1;
    ...
    var addMarkSelectionEvent = function(ul, li) {
    ...
    var addClickListener = function(elem, callback) {
        if (hasTouchSupport) {
            elem.addEventListener("touchstart", callback);
        }
        elem.addEventListener("click", callback);
    };
    var modifyListItem = function() {
    };
    var buildSettingOptionsList = function(parent, items, settingKey) {
    ...
    var ListItem = function(innerHTML, value) {
        return{innerHTML:innerHTML, value:value};
    };
    var getLanguageListItems = function() {
    ...
    var getLanguageMenuItem = function() {
    ...
    var getLanguageSubListItems = function() {
    ...
    var getSupportedLanguagesList = function() {
        var i;
        var languages = [];
    ...
    var getColorListItems = function() {
        return[new ListItem('<span class="cc-checkbox cc-white"></span><span>White</span>', Colors.WHITE), new ListItem('<span class="cc-checkbox cc-yellow"></span><span>Yellow</span>', Colors.YELLOW), new ListItem('<span class="cc-checkbox cc-green"></span><span>Green</span>', Colors.GREEN), new ListItem('<span class="cc-checkbox cc-cyan"></span><span>Cyan</span>', Colors.CYAN), new ListItem('<span class="cc-checkbox cc-blue"></span><span>Blue</span>', Colors.BLUE), new ListItem('<span class="cc-checkbox cc-magenta"></span><span>Magenta</span>',
            Colors.MAGENTA), new ListItem('<span class="cc-checkbox cc-red"></span><span>Red</span>', Colors.RED), new ListItem('<span class="cc-checkbox cc-black"></span><span>Black</span>', Colors.BLACK)];
    };
    var getPercentListItems = function(numArray) {
        var items = [];
        var i = -1;
    ...
    var getCharEdgeStyleListItems = function() {
    ...
    var openSettingsMenu = function(e) {
        openSubMenu.call(this, e);
        this.settingsList.firstChild.click();
    };
    var openSupportedLanguagesMenu = function(e) {
        openSubMenu.call(this, e);
    ...
    var backToSettingsList = function() {
    ...
    var onSettingClick = function(e) {
        this.menuWrapper.className = "cc-" + getSelectedValue(e) + "-view";
        this.settingOptionsListScrollbar.resize();
    };
    var onSupportedLanguagesClick = function(e) {
        var languageCode = getSelectedValue(e);
        this.subtitlesManager.dispatchEvent(SubtitlesManagerEvent.LANGUAGE_SELECTED, {languageCode:languageCode});
        this.close();
    };
    var addSupportedLanguageToMainList = function(languageCode, target) {
    ...
    var selectSupportedLanguageItem = function(languageCode, target) {
        vdb.Utils.removeClass(this.supportedLanguagesMenu.getElementsByTagName("li"), "cc-selected");
        if (target) {
            vdb.Utils.addClass(target, "cc-selected");
        }
    };
    var selectMainLanguageItem = function(languageCode) {
        vdb.Utils.removeClass(this.languageList.children, "cc-selected");
    ...
    var onCcButtonTouchStart = function(e) {
        if (this.isLocked) {
            this.close();
        } else {
    ...
    var toggleSmallPlayerMode = function() {
    ...
    return{init:function(subtitlesManager, ccButton, videoContainer) {
...
vdb.skins.BaseSkin = vdb.core.Class.extend(function() {
    ...
    var setFadeOutSkinTimeout = function() {
    ...
    var setPlayheadPosition = function(pos, restore) {
    ...
    var updatePlayheadPosition = function() {
    ...
    var restorePlayheadPosition = function() {
        var progressBarWidth = parseInt(getComputedStyle(this.progressBar).width);
    ...
    var setCurrentTime = function(newTime) {
    ...
    var updateBufferProgress = function(percentBuffered) {
    ...
    var disableFullscreenButton = function() {
    ...
    var _updateHDStatus = function(show) {
        if (!this.hdButton) {
            return;
        }
    ...
    var displayProgressBar = function(currentTime, duration) {
    ...
    var movePlayhead = function(playheadLeftOffset) {
        utl.setStyle(this.videoPlayhead, {left:playheadLeftOffset + "px"});
    };
    var isStereoscopicModeActive = function() {
        return utl.hasClass(this.stereoscopicButton, "button-active");
    };
    var toggleStereoscopicMode = function(value) {
    ...
    var turnOffStereoscopicMode = function() {
    ...
    var is360Video = function() {
        var currentVideo = this.controller.getCurrentVideo();
        return!!(currentVideo && currentVideo.data360);
    };
    var toggleStereoButton = function(showHide) {
    ...
    var updateInfoDescriptionIfNeeded = function() {
    ...
    var updateInfoTitleIfNeeded = function() {
        if (this.infoTitle) {
    ...
    var showStereoButtonIfNeeded = function() {
    ...
    var hideRelatedButton = function(openCarousel) {
    ...
    var setRelatedButtonText = function() {
        this.relatedElement.innerHTML = "RELATED";
    };
    var showRelatedButton = function() {
        var that = this;
        if (this.relatedElement) {
    ...
    var bindPlayButtonClick = function(isReplay) {
        if (isReplay) {
    ...
    var onSkinActive = function() {
        this.isSkinActive = true;
        fadeInSkin.call(this);
    };
    var onSkinInactive = function() {
    ...
    var onReplayButtonClick = function() {
    ...
    var onDockButtonClick = function() {
    ...
    var onPlayTriggered = function() {
        bindContainerEvents.call(this);
        utl.removeClass(this.container, "stopped-mode");
    };
    var onVideoSelected = function() {
    ...
    var onProgressBarContainerTouchStart = function(e) {
    ...
    var onProgressBarContainerTouchMove = function(e) {
        e.preventDefault();
        if (this.progressBarHidden) {
            return;
        }
    ...
    var onProgressBarContainerTouchEnd = function() {
        if (this.progressBarHidden) {
            return;
        }
        setCurrentTime.call(this);
    ...
    var onProgressBarContainerMouseDown = function() {
        if (this.progressBarHidden) {
            return;
        }
        this.onSeekStart();
    };
    var onProgressBarContainerMouseMove = function(e) {
        if (this.progressBarHidden) {
            return;
        }
    ...
    var onProgressBarContainerMouseUp = function() {
        if (this.progressBarHidden) {
            return;
        }
        setCurrentTime.call(this);
    ...
    var onProgressBarContainerMouseOut = function(e) {
    ...
    var onControlBarRowMouseOver = function() {
        this.isSkinActive = true;
    };
    var onControlBarRowMouseOut = function() {
        this.isSkinActive = false;
    };
    var onControlBarRowTouchAction = function(e) {
        e.preventDefault();
    };
    var onSubtitlesEnabled = function() {
    ...
    var buildRelatedButton = function() {
        var that = this;
        ...
        utl.addPrefixedEventListeners(this.relatedElement, "TransitionEnd", function(e) {
            if (e.propertyName === "width") {
                if (that.relatedElement.clientWidth === 0) {
                    hideRelatedButton.call(that, true);
                } else {
                    setRelatedButtonText.call(that);
                }
            }
    ...
    }, cssText:"", isSkinVisible:false, isBuffering:false, isMobile:!!utl.mobileOs(), clickEvent:utl.mobileOs() ? "touchend" : "click", showResumeAdPoster:false, createTimelinePreview:function() {
    ...
    }, buildTimelineAdBreaks:function() {
    }, removeTimelineAdBreaks:function() {
    }, onAdTimeUpdate:function(e) {
        onTimeUpdate.call(this);
    ...
    }, displayProgressBar:displayProgressBar, onDockButtonCreated:function() {
    ...
    }, nextVideoButtonClick:function() {
        if (this.progressBarHidden) {
            return;
        }
        this.controller.moveToNextVideo();
    }, rewindButtonClick:function() {
        if (this.progressBarHidden) {
            return;
        }
    ...
    }, onStereoscopicButtonClick:function() {
...
vdb.skins.shareScreen.BottomTimePanel = vdb.core.Class.extend(function() {
    ...
    return{init:function(shareScreen, container) {
...
vdb.skins.shareScreen.ShareScreenModel = vdb.core.Class.extend(function() {
    return{init:function(controller, settings, container, shareScreenButton) {
        this.player = controller.getPlayer();
...
vdb.skins.shareScreen.CopiedScreen = vdb.core.Class.extend(function() {
    ...
    }, removeFullScreenStyles:function() {
...
vdb.skins.shareScreen.EmailScreen = vdb.core.Class.extend(function() {
    ...
    }, toggleEmailErrorMessage:function() {
        var utl = vdb.Utils;
        if (this.validateEmail(this.emailFormText.value)) {
            utl.removeClass(this.emailFormLine, "email-screen-error");
            utl.addClass(this.emailFormErrorMessage, "hidden");
    ...
    }, toggleFullScreenStyles:function() {
    ...
    }, hideAbstractEmailScreen:function() {
...
vdb.skins.shareScreen.EmailScreenDesktop = vdb.skins.shareScreen.EmailScreen.extend(function() {
    ...
    return{init:function(shareScreen) {
...
vdb.skins.shareScreen.EmbedScreen = vdb.core.Class.extend(function() {
    ...
    var utl = vdb.Utils;
    var state = vdb.skins.shareScreen.ShareScreenStatesEnum;
    return{init:function(shareScreen, settings) {
...
vdb.skins.VolumeSliderTwoButtons = vdb.EventBus.extend(function() {
    ...
    return{init:function(controller, controlBarRow, addEffect) {
        if (utl.desktopOs()) {
            this.controller = controller;
            this.player = controller.getPlayer();
            this.container = controller.getContainer();
...
vdb.skins.VolumeSlider = vdb.EventBus.extend(function() {
    ...
    var onThumbMouseOver = function() {
        showTooltip.call(this);
        moveTooltip.call(this);
    };
    var onThumbMouseOut = function() {
    ...
    var onVolumeButtonClick = function(e) {
    ...
    return{init:function(controller, parent, options) {
...
vdb.skins.MiniBar = vdb.EventBus.extend(function() {
    ...
    var onMiniBarAction = function(e) {
        if (utl.mobileOs()) {
            e.preventDefault();
        }
        hideMiniBar.call(this);
    };
    var showMiniBar = function() {
        this.active = true;
...
vdb.skins.shareScreen.ShareScreenView = vdb.core.Class.extend(function() {
    ...
    return{init:function(model, title, embedScreenButtonEnabled) {
        this.model = model;
    ...
    }, fadeOutShareScreen:function() {
        utl.addClass(this.socialDock, "fadeOut");
    }, fadeInShareScreen:function() {
...
vdb.skins.shareScreen.ShareScreen = vdb.core.Class.extend(function() {
    ...
    return{init:function(controller, settings, container, shareScreenButton, shareScreenType) {
    ...
    }, close:function(shareScreenType) {
        shareScreenType = shareScreenType || ShareScreenTypesEnum.SHARE_SCREEN_GENERAL;
        if (shareScreenType === ShareScreenTypesEnum.SHARE_SCREEN_GENERAL) {
            closeChildScreens.call(this);
        } else {
    ...
    }, getShareScreenContainer:function() {
        return this.view.shareScreenContainer;
    }, getShareScreenBackButton:function() {
...
vdb.skins.shareScreen.ShareScreenButton = vdb.core.Class.extend(function() {
    ...
    var ShareScreenTypesEnum = vdb.skins.shareScreen.ShareScreenTypesEnum;
    return{init:function(settings, controller) {
...
vdb.skins["skin6"] = vdb.skins.BaseSkin.extend(function() {
    ...
    var videoPlayheadUpdate = function() {
    ...
    var smoothTimelineMove = function() {
        var duration = this.display.getDurationWithoutAds();
        var currentTime = this.display.getCurrentTime();
    ...
    var movePlayhead = function(leftOffset) {
    ...
    }, movePlayhead:movePlayhead, setSocialNetworks:function(socialNetworks, showOnAd, likePosition, shareButtonPosition) {
