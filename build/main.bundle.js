...
var _volumeSliderHorizontal = __webpack_require__(1);
...
var VolumeSliderHorizontal = function (_BaseComponent) {
    _inherits(VolumeSliderHorizontal, _BaseComponent);

    function VolumeSliderHorizontal(controller, parent, options, addEffect) {
        _classCallCheck(this, VolumeSliderHorizontal);

        var _this = _possibleConstructorReturn(this, (VolumeSliderHorizontal.__proto__ || Object.getPrototypeOf(VolumeSliderHorizontal)).call(this));

        _this.controller = controller;
        _this.player = controller.getPlayer();
        _this.parent = parent;
        _this.options = options || {};
        _this.addEffect = !!addEffect;
        _this.buildControls.call(_this);
        _this.attachPlayerEvents.call(_this);
        _this.attachSkinEvents.call(_this);
        return _this;
    }
    ...
    _createClass(VolumeSliderHorizontal, [{
        ...
        key: "dispatchUserInteractionEvent",
        value: function dispatchUserInteractionEvent(interactionType) {
            this.player.dispatchEvent(PlayerEvent.USER_INTERACTION, { "interactionType": interactionType });
        }
    }, {
        key: "onVolumeChange",
        ...
        value: function setVolume() {
            var volumeSliderOffset = Math.round(common.getOffset(this.volumeSlider).left) + this.volumeSliderLeftBorderWidth;
            var volumeSliderWidth = this.volumeSlider.clientWidth;
            if (this.pageXPos < volumeSliderOffset) {
                this.controller.setVolume(0);
            } else {
...
exports.default = VolumeSliderHorizontal;
